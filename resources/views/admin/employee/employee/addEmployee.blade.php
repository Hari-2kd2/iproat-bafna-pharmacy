                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInput">@lang('employee.supervisor')<span class="validateRq">*</span></label>

                                        <select name="supervisor_id" class="form-control supervisor_id required select2" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('work_shift', $workShift, old('work_shift'), ['class' => 'form-control work_shift select2 required']) }}
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('incentive', $incentive, old('incentive'), ['class' => 'form-control incentive select2 required']) }}
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('employee.salary_limit')<span class="validateRq">*</span></label>
                                        {{ Form::select('salary_limit', $salaryLimit, old('salary_limit'), ['class' => 'form-control salary_limit select2 required']) }}
                                    </div>
                                </div>
                                <div class="col-md-3">
