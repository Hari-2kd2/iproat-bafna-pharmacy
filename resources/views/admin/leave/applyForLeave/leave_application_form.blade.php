                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="exampleInput">@lang('leave.day_type')<span
                                                class="validateRq">*</span></label>
                                        {{ Form::select('day_type', ['1' => 'Full Day', '0.5' => 'Half Day'], old('day_type'), ['class' => 'form-control day_type select2 required']) }}
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
...
<script>
    jQuery(function() {
        ...
        $(document).on("change", ".application_from_date,.application_to_date,.day_type", function() {
                    ...
                    success: function(data) {
                        ...
                        if (day_type == '1') {
                            ...
                            if (application_from_date != application_to_date) {
                                $.toast({
                                    heading: 'Warning',
                                    text: 'Invalid From and To Dates',
                                    position: 'top-right',
                                    loaderBg: '#ff6849',
                                    icon: 'warning',
                                    hideAfter: 3000,
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == 0) {
                            $.toast({
                                heading: 'Warning',
                                text: leave_type_id == 2 ?
                                    'You are not eligible for selected leave type!' :
